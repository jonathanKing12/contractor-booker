...
public class WriteTest extends BaseTest {
    ...
    @Test
    public void shouldThirdReplaceTheFirstDeletedRowTest() throws RecordNotFoundException,
            DataSourceException, DuplicateKeyException {
        deleteRecord(5);
        deleteRecord(27);

        String[] expectedRow = { "changed name", "changed location", "changed speciallity", "11",
                "$15.03", "" };
