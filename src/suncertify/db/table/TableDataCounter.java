...
class TableDataCounter {
    ...
    /**
     * Returns the size of the gap between the last piece of data read from the table to the start of the specified row. If the specified row has
     * already been read then a negative number will be returned.
     * 
     * @param rowNumber
