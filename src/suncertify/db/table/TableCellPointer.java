...
class TableCellPointer {
	...
	/**
	 * Moves this table cell pointer right one column to the next cell in the current row. If the
	 * current cell is the last cell of the current row then the next cell will be the first cell of
	 * the next row
	 * 
	 **/
